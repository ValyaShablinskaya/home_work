...
public class SearchEnginePunctuationNormalizeTest {

    ISearchEngine iSearchEngine = new SearchEnginePunctuationNormalizer(new EasySearch(), new WarAndPeace());
    ...
    void searchWithExamplesFromHomework() {
        ...
        Assertions.assertEquals(1, iSearchEngine.search(text1, "привет"));
        Assertions.assertEquals(1, iSearchEngine.search(text1, "как"));
        Assertions.assertEquals(1, iSearchEngine.search(text1, "дела"));
        Assertions.assertEquals(1, iSearchEngine.search(text2, "какдела"));
        Assertions.assertEquals(1, iSearchEngine.search(text3, "привет"));
        Assertions.assertEquals(1, iSearchEngine.search(text3, "какдела"));
        Assertions.assertEquals(1, iSearchEngine.search(text4, "как"));
        Assertions.assertEquals(1, iSearchEngine.search(text4, "дела"));
        Assertions.assertEquals(1, iSearchEngine.search(text4, "Что"));
        Assertions.assertEquals(1, iSearchEngine.search(text4, "делаешь"));
        Assertions.assertEquals(1, iSearchEngine.search(text5, "Привет-привет"));
        Assertions.assertEquals(1, iSearchEngine.search(text6, "Привет"));
        Assertions.assertEquals(1, iSearchEngine.search(text6, "привет"));
        Assertions.assertEquals(1, iSearchEngine.search(text7, "4-х"));
        Assertions.assertEquals(1, iSearchEngine.search(text8, "один"));
        Assertions.assertEquals(1, iSearchEngine.search(text8, "и"));
        Assertions.assertEquals(1, iSearchEngine.search(text8, "1"));
        Assertions.assertEquals(1, iSearchEngine.search(text9, "бабушка"));
        Assertions.assertEquals(1, iSearchEngine.search(text9, "бабушке"));
        Assertions.assertEquals(1, iSearchEngine.search(text9, "бабушка"));
    }
    ...
    void searchCaseSensitive() {
        ...
        long expected = 1;
        long actual = iSearchEngine.search(text, "Хищник");
    ...
    void searchPassageFromTheBook() {
        ...
        long expected = 2;
        long actual = iSearchEngine.search(text, "лошадь");
        assertEquals(expected, actual);
    }
}
